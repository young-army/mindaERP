<li><a href="index.php" class="widgets">Dashboard</a></li>
				...
				<li><a href="#support1" class="support">Sea Freight</a>
					...
					<ul id="support1">
						...
						<li><a href="seafreightcntsfe.php">Credit Note SFE</a></li>
						<li><a href="seafreightimport.php">Import</a></li>
						<li><a href="seafreightcntsfi.php">Credit Note SFI</a></li>
						<li><a href="seafreightconsol.php">Consol</a></li>
						<li><a href="seafreightcntsfc.php">Credit Note SFC</a></li>
					</ul>
				</li>
				...
				<li><a href="#support2" class="support">Domestic</a>
					...
					<ul id="support2">
						...
						<li><a href="domesticcntdoo.php">Credit Note DOO</a></li>
						<li><a href="domesticincoming.php">Incoming</a></li>
						<li><a href="domesticcntdoi.php">Credit Note DOI</a></li>
					</ul>
				</li>
				...
				<li><a href="#support3" class="support">Accounting</a>
					...
					<ul id="support3">
						...
						<li><a href="accountingpajak.php">Pajak (PPN)</a></li>
						<li><a href="accountingtater.php">Tanda Terima</a></li>
						<li><a href="accountingresep.php">Receipt Kuitansi</a></li>
					</ul>
				</li>
				...
				<li><a href="#support4" class="support">TPS</a></li>
					...
					<ul id="support4">
						...
						<li><a href="tpsmaster.php">Master</a></li>
						<li><a href="tpshouse.php">House</a></li>
						<li><a href="tpsinvoice.php">Invoice</a></li>
						<l><a href="tpsrevhouse.php">Rev House</a></li>
					</ul>
				</li>