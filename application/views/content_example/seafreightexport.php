<?php
$__page_title = "Sea Freight &raquo; Export";
...
?>
		...
		function removeData(kode) {
			if(confirm('Are you sure?')) {
				location.href = 'seafreightexport.php';
			}
		}
		</script>
			...
			<form action="" method="get" id="fFilter" name="fFilter">
				<p>
					<div id="box-filter">Search By&nbsp;
						...
						<input type="button" value="Show All" class="t-button-orange t-button-medium" onclick="location.href='seafreightexport.php';">
					</div>
				</p>
			</form>			
		</div>
		...
		<div id='pos_r'>
			...
			<a href="seafreightexport_edit.php" class="btn btn1 btn_link new"><span>Add New</span></a>
		</div>
		...
		<table cellpadding="0" cellspacing="0" border="0" class="stdtable stdtablequick">
			...
			<tbody>
				<tr>
					<td>1</td>
					<td>01-2013990/00</td>
					<td>SINGAPORE CHEMI-CON (PTE)</td>
					<td>INDONESIA - JKT</td>
					<td>SINGAPORE - SIN</td>
					<td>17 July 2013</td>
					<td>618-6993 6661</td>
					<td align="center">
						<a href="seafreightexport_edit.php" title="Edit item" class="edit"><span>Edit</span></a>
						<a href="#Delete" onclick="removeData('001')" title="Remove item" class="delete"><span>Delete</span></a>
					</td>
				</tr>	
				<tr>
					<td>2</td>
					<td>02-77189928/01</td>
					<td>INDONESIA NIAGA TAMA (PT)</td>
					<td>MALAYSIA - MY</td>
					<td>INDONESIA - SUB</td>
					<td>15 July 2013</td>
					<td>772-2661 6351</td>
					<td align="center">
						<a href="seafreightexport_edit.php" title="Edit item" class="edit"><span>Edit</span></a>
						<a href="#Delete" onclick="removeData('002')" title="Remove item" class="delete"><span>Delete</span></a>
					</td>
				</tr>	
				<tr>
					<td>3</td>
