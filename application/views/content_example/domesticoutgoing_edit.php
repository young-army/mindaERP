<?php
# set page title here
$__page_title = "Domestic &raquo; Outgoing Form";
	...
	<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" id="myForm" class="stdform">
		...
		<div class='pos_r_button'>
			<p class="stdformbutton">
				...
				<input type="button" class="cancel radius2 btn_back" value="Cancel" onclick="location.href='domesticoutgoing.php';"/>
			</p>
		</div>
				...
				<tr>
					<td width="50%">
						...
						<p>
							<label class="required">&nbsp;</label>
							<span class="field">
								<span class="highlight">NON JKT</span>
							</span>
						</p>
						<p>
						...
						<p>
							...
							<span class="field">
								<input type="text" id="firstflight" name="firstflight" class="vsmallinput" size="10" maxlength="10" />
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2nd Flight&nbsp;&nbsp;&nbsp;
								<input type="text" name="secondflight" id="secondflight" size="10" maxlength="10" value="" class="vsmallinput" value="" />
							</span>
						</p>
						<p>
						...
						<p>
							<label class="required">Trucking</label>
							<span class="field">
								<input type="text" name="trucking" size="40" maxlength="50" class="mediuminput" />
							</span>
						</p>
					</td>
					<td>
						...
						<p>
							...
							<span class="field">
								<select name="toc" id="toc">
									<option value="FIN_SUB">FIN SUB</option>
								</select>
								<textarea style="display: none" rows="4" cols="50" class="mediuminput"><?="INDONESIA CHEMI-CON, PT\r\nEJIP INDUSTRIAL PARK PLOT 4C\r\nLEMAH ABANG\r\nBEKASI 17550"?></textarea>
							</span>
						</p>
						...
						<p>
							<label class="required">&nbsp;</label>
							<span class="field">
								<input type="text" name="destination" size="40" maxlength="50" class="mediuminput" />
							</span>
						</p>
					</td>
				</tr>
