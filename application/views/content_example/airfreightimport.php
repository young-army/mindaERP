<?php
$__page_title = "Air Freight &raquo; Import";
...
?>
		...
		function removeData(kode) {
			if(confirm('Are you sure?')) {
				location.href = 'airfreightimport.php';
			}
		}
		</script>
			...
			<form action="" method="get" id="fFilter" name="fFilter">
				<p>
					<div id="box-filter">Search By&nbsp;
						...
						<input type="button" value="Show All" class="t-button-orange t-button-medium" onclick="location.href='airfreightimport.php';">
					</div>
				</p>
			</form>			
		</div>
		...
		<div id='pos_r'>
			...
			<a href="airfreightimport_edit.php" class="btn btn1 btn_link new"><span>Add New</span></a>
		</div>
		...
		<table cellpadding="0" cellspacing="0" border="0" class="stdtable stdtablequick">
			...
			<tbody>
				<tr>
					...
					<td>000-7379 7771</td>
					<td align="center">
						<a href="airfreightimport_edit.php" title="Edit item" class="edit"><span>Edit</span></a>
