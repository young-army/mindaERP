<?php
$__page_title = "Air Freight &raquo; Export";
...
?>
		...
		function removeData(kode) {
			if(confirm('Are you sure?')) {
				location.href = 'airfreightexport.php';
			}
		}
		</script>
			...
			<form action="" method="get" id="fFilter" name="fFilter">
				<p>
					<div id="box-filter">Search By&nbsp;
						...
						<input type="button" value="Show All" class="t-button-orange t-button-medium" onclick="location.href='airfreightexport.php';">
					</div>
				</p>
			</form>			
		</div>
		...
		<div id='pos_r'>
			...
			<a href="airfreightexport_edit.php" class="btn btn1 btn_link new"><span>Add New</span></a>
		</div>
		...
		<table cellpadding="0" cellspacing="0" border="0" class="stdtable stdtablequick">
			...
			<tbody>
				<tr>
					...
					<td>618-6993 6661</td>
					<td align="center">
						<a href="airfreightexport_edit.php" title="Edit item" class="edit"><span>Edit</span></a>
