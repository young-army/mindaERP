...
jQuery(document).ready(function(){
	...
	function enterMessage() {
		...
		if(msg != '') {
			jQuery('#chatmessageinner').append('<p><img src="js/images/thumbs/avatar12.png" alt="" />'
			...
			window.setTimeout(  
				function() {  
					...
					jQuery('#chatmessageinner').append('<p class="reply"><img src="js/images/thumbs/avatar13.png" alt="" />'
